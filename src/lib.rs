...
#[derive(Debug)]
pub struct YieldFarmProcessor {
    verbose: bool,
    processed_count: usize,
}

impl YieldFarmProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting YieldFarm processing");
    
    let mut processor = YieldFarmProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = YieldFarmProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = YieldFarmProcessor::new(false);
